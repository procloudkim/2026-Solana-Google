...
CATEGORIES: dict[str, dict[str, Any]] = {
    "Solana Engine": {
        "slug": "solana-engine",
        "description": "Solana program, RPC, transaction, token, runtime 설계 자료를 찾기 위한 주제 색인입니다.",
        "keywords": (
            "solana",
            "솔라나",
            "anchor",
    ...
    "GCP Infrastructure": {
        ...
        "description": "Google Cloud 배포, event, data, managed AI infrastructure 자료를 찾기 위한 주제 색인입니다.",
        "keywords": (
            "google cloud",
            "gcp",
            "cloud run",
    ...
    "AP2/x402 Payment Protocols": {
        ...
        "description": "AP2, x402, pay.sh 등 Agentic Commerce 결제 protocol 자료를 찾기 위한 주제 색인입니다.",
        "keywords": (
            "ap2",
            "x402",
            "pay.sh",
    ...
    "Google ADK": {
        "slug": "google-adk",
        "description": "Google ADK, Agents CLI, Gemini, agent 구성 자료를 찾기 위한 주제 색인입니다.",
        "keywords": (
            "google adk",
...
def _render_index(entries: list[dict[str, Any]], wiki_root: Path) -> str:
    ...
    lines.extend(["", "## 주제별 source module", ""])
